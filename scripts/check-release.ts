...
const REQUIRED_FILES = [
  ...
  'extensions/pi-reads/batch-ingest.ts',
  'extensions/pi-reads/clipboard.ts',
  'extensions/pi-reads/collection-ingest.ts',
  'src/application/batch-ingestion-service.ts',
  'src/application/collection-ingestion-service.ts',
  'src/application/digest-preparation-service.ts',
  'src/application/reading-collection-service.ts',
  'src/core/record-group.ts',
  'src/core/synthesis-review.ts',
  'src/core/generation-templates.ts',
  'docs/batch-ingestion.md',
  'docs/clipboard-and-transcripts.md',
  'docs/feed-and-newsletter-ingestion.md',
  'docs/generation-templates.md',
  'docs/multi-source-synthesis.md',
  'docs/reading-packs.md',
  'package.json',
  'schemas/v1/article-user-state.schema.json',
  'schemas/v1/citation-diagnostics.schema.json',
  'schemas/v1/generation-template.schema.json',
  ...
  'scripts/prepare-kindle-digest.ts',
  'src/application/maintenance-service.ts',
  'src/application/library-verification.ts',
  'src/core/record-validation.ts',
  'src/core/ingest/feed.ts',
  'src/core/ingest/newsletter.ts',
  'src/core/ingest/transcript.ts',
